...
class controlempleados2 extends plantilla
{
...
<script>
  ...
  function iredit()
  {
    if (confirm("Presiona OK para confirmar la edicion."))
    {
      ...
      var vals = {
        ...
        if ($("#sueldo").val()!="")
        {
          vals["Sueldo"] = $("#sueldo").val();
        }else{con++;}
        if ($("#puesto").val()!="")
        {
          vals["Puesto"] = $("#puesto").val();
        }else{con++;}
  ...
  function buscar()
  {
    ...
    {
      var ur = "controlempleados2.php?pardebusqueda="+$("#pald").val()
...
Cedula:<input type="text" id="cedula" class="form-control" style="width:70%;"> 
...
Suledo:<input type="text" id="sueldo" class="form-control" style="width:70%;"> 
Puesto:<input type="text" id="puesto" class="form-control" style="width:70%;"> 
...
function buscarE($par, $val)
{
  ...
  {
    $qry = sprintf("SELECT * FROM empleado WHERE FechaNacimiento = '%s'",$val);
  }//end else if
  else
  {
    $qry = sprintf("SELECT * FROM empleado WHERE %s = '%s'",$par,$val);
  }//end if
